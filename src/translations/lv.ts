export default {
  translation: {
    ...
    dynamic: {
      ...
      leagues: "līgas",
      own: "savu",
      customizable: "pielāgojamo",
      automated: "automatizēto",
      "easy-to-use": "viegli lietojamo",
    },
    entries: "Pieteikumi",
    ...
    sports_platform: "sporta platformu",
    free: "Bezmaksas",
    freeTrial: "Bezmaksas izmēģinājums",
    go_platform: "Uz platformu",
    go_to_platform: "Sākt bez maksas",
    highlightZone: "Izcelšanas zona",
    launch_custom_platform:
      "Vai pārvaldiet savu sporta organizāciju Tournated platformā - <span class='highlight'>bez maksas</span>",
    ...
    sports: "Sports",
    start_for_free: "Rezervējiet demo",
    launch_your: "Palaid savu",
    ...
    promo: {
      launch_your_own: "Attīstiet un monetizēt",
      web_platform_and_mobile_app: "savu organizāciju kopā ar Tournated",
